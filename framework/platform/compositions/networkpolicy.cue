...
// NetworkPolicyComposition maps an XNetworkPolicy claim to a Kubernetes NetworkPolicy.
#NetworkPolicyComposition: {
	apiVersion: "apiextensions.crossplane.io/v1"
	kind:       "Composition"
	metadata: {
		name: "networkpolicy-standard"
		labels: {
			"crossplane.io/xrd":   "xnetworkpolicies.\(#ApiGroup)"
...
networkPolicyComposition: #NetworkPolicyComposition
