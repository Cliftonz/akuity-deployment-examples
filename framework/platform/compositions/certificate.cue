...
// CertificateComposition maps an XCertificate claim to a cert-manager Certificate.
#CertificateComposition: {
	...
	metadata: {
		...
		labels: {
			"crossplane.io/xrd":    "xcertificates.\(#ApiGroup)"
...
certificateComposition: #CertificateComposition
