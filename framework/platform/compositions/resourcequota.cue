...
// ResourceQuotaComposition maps an XResourceQuota claim to a Kubernetes ResourceQuota.
#ResourceQuotaComposition: {
	apiVersion: "apiextensions.crossplane.io/v1"
	kind:       "Composition"
	metadata: {
		name: "resourcequota-standard"
		labels: {
			"crossplane.io/xrd":   "xresourcequotas.\(#ApiGroup)"
...
resourceQuotaComposition: #ResourceQuotaComposition
