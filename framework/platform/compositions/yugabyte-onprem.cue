...
// YugabyteCompositionOnPrem — same XDatabase XRD, on-prem / edge regional
// sub-deployment running on local persistent storage. Joins the same global
// xCluster universe as the AWS and GCP variants. Selection: provider=onprem
// + engine=yugabytedb.
#YugabyteCompositionOnPrem: {
	apiVersion: "apiextensions.crossplane.io/v1"
	kind:       "Composition"
	metadata: {
		name: "yugabyte-onprem"
		labels: {
			"crossplane.io/xrd":    "xdatabases.\(#ApiGroup)"
			"infra.k8/composition": "yugabyte-onprem"
					...
					base: {
						...
						spec: {
							...
							forProvider: {
								...
								values: {
									isMultiAz: true
									AZ:        "ap-southeast-onprem"
									// Local PV storage; Rook-Ceph or similar.
									storage: {
										master: {storageClass: "rook-ceph-block"}
										tserver: {storageClass: "rook-ceph-block"}
									}
...
yugabyteCompositionOnPrem: #YugabyteCompositionOnPrem
