...
// ArgoAppProjectComposition maps an XArgoAppProject claim to an Argo CD AppProject.
#ArgoAppProjectComposition: {
	apiVersion: "apiextensions.crossplane.io/v1"
	kind:       "Composition"
	metadata: {
		name: "argoappproject-standard"
		labels: {
			"crossplane.io/xrd":    "xargoappprojects.\(#ApiGroup)"
...
argoAppProjectComposition: #ArgoAppProjectComposition
