...
// ArgoEventSourceComposition maps an XArgoEventSource claim to an Argo Events EventSource.
#ArgoEventSourceComposition: {
	apiVersion: "apiextensions.crossplane.io/v1"
	kind:       "Composition"
	metadata: {
		name: "argoeventsource-standard"
		labels: {
			"crossplane.io/xrd":    "xargoeventsources.\(#ApiGroup)"
...
argoEventSourceComposition: #ArgoEventSourceComposition
